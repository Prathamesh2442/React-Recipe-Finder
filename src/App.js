  ...
  return (
    <RecipeContainer>
      ...
      >
        ...
        <DialogActions>
          <SeeNewTab onClick={() => window.open("https://www.youtube.com/")}>Open Yt</SeeNewTab>
      ...
      <>
        ...
        <div id="chat">
          <div className="innerchat" onClick={window['start']}>
            <button onclick="start()" id="btn" className="btn2"><svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" className="bi bi-chat-dots" viewBox="0 0 16 16">
